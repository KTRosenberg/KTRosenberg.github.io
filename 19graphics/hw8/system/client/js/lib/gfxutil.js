...
window.GFX = (function() {
    ...
    function initVideoTexture(gl, textureSlot, args) {
        args = args || {};
        ...
        if (args.textureParams) {
            const textureParams = args.textureParams;
            const paramCount    = textureParams.length;
            for (let i = 0; i < paramCount; i += 3) {
                gl.texParameteri(
                    textureParams[i],
                    textureParams[i + 1],
                    textureParams[i + 2]
