...
async function setup(state) {
    ...
    const Parametric_Triangle_Strip = {
        ...
        console.log(state.layoutBuilder.vertexOffset);
    ...
    console.log(state.layouts[0]);
    console.log(state.layouts[1]);
    console.log(state.layouts[2]);
    console.log(state.layouts[3]);
    ...
    // create buffer for attributes
    {
        ...
        console.log(cubeIndexData);
        console.log(sphereInfo.indices);
        console.log(torusInfo.indices);
        console.log(cylInfo.indices);
